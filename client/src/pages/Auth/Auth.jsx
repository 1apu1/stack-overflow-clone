...
<div style={{display:"flex",justifyContent:"space-between"}}>
        ...
        </label>
        {
             isSignup && (
              <label htmlFor='check'>
                <input type="checkbox" id="check"/>
                <p style={{ fontSize:"13px"}}> Opt-in to receive occasional,<br /> product updates, user research invitations,<br />
                company annoucements, and digests</p>
              </label>
             )
